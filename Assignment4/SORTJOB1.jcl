...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z66944.JCL.SORTIN1,DISP=SHR
//SORTOUT  DD DSN=Z66944.JCL.SORTOUT1,DISP=OLD
//SYSIN    DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN1      DD DSN=Z66944.JCL.SORTIN1,DISP=SHR
//TOOLIN   DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN2      DD DSN=Z66944.JCL.SORTOUT1,DISP=SHR
//TOOLIN   DD *
...
//SORTOUT  DD DSN=Z66944.JCL.SORTOUT1,DISP=(MOD,DELETE,DELETE)
//*
